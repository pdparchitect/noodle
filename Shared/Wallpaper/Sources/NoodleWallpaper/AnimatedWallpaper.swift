...
@MainActor public final class AnimatedWallpaperView: NSView {
    private var url: URL?
    ...
    public var completedLoops: Int { looper?.loopCount ?? 0 }
    ...
    public func configure(url: URL, kind: BackgroundMediaKind, reduceMotion: Bool) {
