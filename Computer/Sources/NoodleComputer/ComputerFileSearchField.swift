...
struct ComputerFileSearchField: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSTextField {
        ...
        field.setAccessibilityLabel("Search files")
    ...
    func sizeThatFits(_ proposal: ProposedViewSize, nsView: NSTextField, context: Context) -> NSSize? {
    ...
    @MainActor final class Coordinator: NSObject, NSTextFieldDelegate {
        var parent: ComputerFileSearchField
        init(_ parent: ComputerFileSearchField) { self.parent = parent }
