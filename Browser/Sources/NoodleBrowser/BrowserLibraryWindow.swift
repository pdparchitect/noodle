...
@MainActor final class BrowserLibraryWindow {
    weak var host: BrowserLibraryWindowHost.View?
...
struct BrowserLibraryWindowHost: NSViewRepresentable {
    let library: BrowserLibraryWindow
    ...
    final class View: NSView {
        ...
        init(library: BrowserLibraryWindow) {
