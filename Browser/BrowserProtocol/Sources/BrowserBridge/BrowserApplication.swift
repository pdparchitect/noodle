...
public enum BrowserApplication {
    ...
    public static func locate(build: BrowserBuildIdentity = .current) -> URL? {
        guard BrowserBuildIdentity.processIdentity != nil else { return nil }
    ...
    public static func isInstalled(at url: URL?, build: BrowserBuildIdentity = .current) -> Bool {
