...
final class MCPFileContentTests: XCTestCase {
    ...
    func testDestinationLinksAreRejectedAndExistingFilesPreserved() throws {
        ...
        try FileManager.default.createSymbolicLink(at: noodle.url.appendingPathComponent("mcp-attachments"), withDestinationURL: outside)
