...
case "$data_container" in
    development) bundle_identifier="com.pdparchitect.noodle.applet.local"; app_name="Noodle Applet Dev"; group_suffix="com.pdparchitect.noodle.applets.local"; document_extension="noodlet-dev"; ;;
    production) bundle_identifier="com.pdparchitect.noodle.applet"; app_name="Noodle Applet"; group_suffix="com.pdparchitect.noodle.applets"; document_extension="noodlet"; ;;
