...
case "$bundle_identifier" in
    ...
    com.pdparchitect.noodle.browser|com.pdparchitect.noodle.browser.local)
        expected_feed='https://github.com/pdparchitect/noodle/releases/download/browser-latest/appcast.xml' ;;
    com.pdparchitect.noodle.hub|com.pdparchitect.noodle.hub.local)
        expected_feed='https://github.com/pdparchitect/noodle/releases/download/hub-latest/appcast.xml' ;;
esac
