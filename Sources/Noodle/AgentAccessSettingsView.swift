    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("New bots start in restricted mode. Turn on autonomous access for a bot that needs access beyond its private workspace. Claude Code, FX and Grok Build currently require autonomous access. Existing bots keep their access settings.")
            }
        }
        .formStyle(.grouped)
    }
