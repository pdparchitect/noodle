...
private enum HostPaths {
    ...
    static func workspace(_ id: String) throws -> URL {
        ...
        let root = home.appendingPathComponent("Library/Containers/com.pdparchitect.superbot/Data/Library/Application Support/SuperBot/Agents", isDirectory: true).resolvingSymlinksInPath()
...
private final class HostSession: NSObject, AgentHostService {
    ...
    private let queue = DispatchQueue(label: "SuperBot.agent-host-session")
        ...
        queue.async {
            ...
            do {
                ...
                child.environment = [
                    ...
                    "SUPERBOT_AGENT_ID": agentID.lowercased(), "SUPERBOT_WORKSPACE": workspace.path
                ]
