...
private final class CodexAgentProcess {
    ...
    private static let dynamicTools: [[String: Any]] = [
        [
            ...
            "description": "Read and consume every unread direct or group message for this bot. Each delivery explicitly identifies this bot as me, provides a named participant roster, and annotates the sender as user, me, bot, or system. This must be the first action after every SuperBot inbox-changed event. The programmatic bridge returns the JSON payload directly; forward the complete value with text(result), never result.content.",
            "inputSchema": [
                "type": "object",
                "properties": [:],
