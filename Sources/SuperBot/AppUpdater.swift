...
final class AppUpdater: NSObject, ObservableObject, SPUUpdaterDelegate {
    ...
    var canRelaunch: Bool { SuperBotStore.active?.canRelaunchForUpdate ?? false }
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Updates come directly from GitHub and are verified before installation. SuperBot waits for agents to finish and for unsent messages and open editors before restarting.")
            }
