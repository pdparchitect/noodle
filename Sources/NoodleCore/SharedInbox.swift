...
public enum SharedInboxError: LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .unavailable: return "Sharing is unavailable in this build. Open the signed Noodle app once, then try again."
...
public struct SharedInbox: Sendable {
    ...
    public static func configured(bundle: Bundle = .main) throws -> SharedInbox {
        guard let identifier = bundle.object(forInfoDictionaryKey: "NoodleSharedGroup") as? String,
