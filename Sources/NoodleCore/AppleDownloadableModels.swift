...
/// cannot silently change what a recommendation downloads. No Hub code is run.
public struct AppleModelRecommendation: Identifiable, Sendable {
    ...
    public static let recommended: [Self] = [
        .init(name: "Qwen3 4B Instruct", repository: "mlx-community/Qwen3-4B-Instruct-2507-4bit",
        ...
        .init(name: "Qwen3 8B", repository: "mlx-community/Qwen3-8B-4bit",
