...
@MainActor
public final class AntigravitySetupProvider: HarnessSetupProviding {
    public init() {}
    ...
    public static func command(for installation: HarnessInstallation, home: URL? = nil) -> String {
...
@MainActor
public enum AntigravityHostProbe {
