...
@MainActor
package final class AntigravitySetupProvider: HarnessSetupProviding {
    package init() {}
    ...
    package static func command(for installation: HarnessInstallation, home: URL? = nil) -> String {
...
@MainActor
package enum AntigravityHostProbe {
