...
@MainActor public protocol HarnessRuntimeConnection: RuntimeStopConnection {
...
extension ExtendedAgentConnection: HarnessRuntimeConnection {
    @MainActor public func startHarness(provider: HarnessProvider, agentID: UUID, executablePath: String,
                                extendedAccess: Bool, appsEnabled: Bool, sessionID: UUID?, resumeSession: Bool,
                                modelIdentifier: String?, effortIdentifier: String?,
                                reply: @escaping (Int32, String?) -> Void) {
        if extendedAccess {
