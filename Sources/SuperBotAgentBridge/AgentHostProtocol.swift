...
public enum AgentHostIdentity {
    public static let service = "com.pdparchitect.superbot.agent-host"
    public static let application = "com.pdparchitect.superbot"

    public static func requirement(for identifier: String, bundle: Bundle = .main) -> String? {
        guard let team = bundle.object(forInfoDictionaryKey: "SuperBotSigningTeam") as? String,
