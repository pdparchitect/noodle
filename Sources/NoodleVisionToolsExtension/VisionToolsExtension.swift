...
@main
struct VisionToolsExtension: AppExtension {
    var configuration: some AppExtensionConfiguration { VisionToolsConfiguration() }
}

struct VisionToolsConfiguration: AppExtensionConfiguration {
