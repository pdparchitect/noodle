...
2. Read the [project instructions](AGENTS.md).
3. Keep the change focused and run the relevant checks. Keep documentation short and practical.
...
See [releases](docs/releases.md) for versioning and publishing.
