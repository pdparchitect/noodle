...
- Open a browser card from a bot on a Noodle Hub to watch its tab live in a window here, and click, type and scroll in it. The browser keeps running on the Hub's Mac.
