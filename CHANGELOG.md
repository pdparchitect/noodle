...
- Teach bots the Applet skill's new `noodlet typecheck` command, which checks any Swift file or folder without building a noodlet, and the `permissions` manifest key for microphone and speech recognition.
