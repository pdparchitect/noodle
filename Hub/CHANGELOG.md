...
- Run computers for the Hub's bots in Noodle Computer on the Hub's Mac. People make them from Noodle; each belongs to the person who made it and reaches only the bots they choose. Install Noodle Computer on the Hub's Mac to use them.
